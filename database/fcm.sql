...
-- Dumping structure for table cluster.tb_admin
...
-- Dumping data for table cluster.tb_admin: ~1 rows (approximately)
INSERT INTO `tb_admin` (`user`, `pass`) VALUES
	('admin', 'admin');

-- Dumping structure for table cluster.tb_bidangilmu
...
-- Dumping data for table cluster.tb_bidangilmu: ~5 rows (approximately)
...
-- Dumping structure for table cluster.tb_dosen
...
-- Dumping data for table cluster.tb_dosen: ~34 rows (approximately)
...
-- Dumping structure for table cluster.tb_kriteria
...
-- Dumping data for table cluster.tb_kriteria: ~5 rows (approximately)
...
-- Dumping structure for table cluster.tb_penelitian
...
-- Dumping data for table cluster.tb_penelitian: ~316 rows (approximately)
...
-- Dumping structure for table cluster.tb_prodi
...
-- Dumping data for table cluster.tb_prodi: ~0 rows (approximately)
...
-- Dumping structure for table cluster.tb_rel_dosen
...
INSERT INTO `tb_rel_dosen` (`ID`, `id_dosen`, `id_kriteria`, `nilai`, `prodi_id`, `nilai_kriteria`, `penelitian`, `pengajaran`, `bimbingan`) VALUES
	...
	(623, 54, 15, 2, 5, 0, 0, 2, 0),
	(624, 54, 16, 0, 5, 0, 0, 0, 0),
	(627, 55, 4, 5, 5, 0, 0, 0, 5),
	(628, 55, 12, 4, 5, 0, 0, 1, 3),
	(629, 55, 13, 0, 5, 0, 0, 0, 0),
	(630, 55, 15, 2, 5, 0, 1, 1, 0),
	(631, 55, 16, 0, 5, 0, 0, 0, 0),
	(634, 56, 4, 7, 5, 0, 1, 3, 3),
	(635, 56, 12, 3, 5, 0, 0, 0, 3),
	(636, 56, 13, 0, 5, 0, 0, 0, 0),
	(637, 56, 15, 0, 5, 0, 0, 0, 0),
	(638, 56, 16, 0, 5, 0, 0, 0, 0),
	(641, 57, 4, 0, 5, 0, 0, 0, 0),
	(642, 57, 12, 4, 5, 0, 0, 1, 3),
	(643, 57, 13, 0, 5, 0, 0, 0, 0),
	(644, 57, 15, 5, 5, 0, 1, 3, 1),
	(645, 57, 16, 0, 5, 0, 0, 0, 0),
	(648, 58, 4, 7, 5, 0, 1, 4, 2),
	(649, 58, 12, 4, 5, 0, 0, 0, 4),
	(650, 58, 13, 0, 5, 0, 0, 0, 0),
	(651, 58, 15, 0, 5, 0, 0, 0, 0),
	(652, 58, 16, 0, 5, 0, 0, 0, 0),
	(655, 59, 4, 2, 6, 0, 0, 0, 2),
	(656, 59, 12, 6, 6, 0, 0, 4, 2),
	(657, 59, 13, 0, 6, 0, 0, 0, 0),
	(658, 59, 15, 1, 6, 0, 0, 0, 1),
	(659, 59, 16, 0, 6, 0, 0, 0, 0),
	(662, 60, 4, 0, 6, 0, 0, 0, 0),
	(663, 60, 12, 4, 6, 0, 0, 4, 0),
	(664, 60, 13, 0, 6, 0, 0, 0, 0),
	(665, 60, 15, 1, 6, 0, 1, 0, 0),
	(666, 60, 16, 0, 6, 0, 0, 0, 0),
	(669, 61, 4, 1, 6, 0, 0, 0, 1),
	(670, 61, 12, 3, 6, 0, 0, 0, 3),
	(671, 61, 13, 1, 6, 0, 0, 0, 1),
	(672, 61, 15, 6, 6, 0, 1, 3, 2),
	(673, 61, 16, 0, 6, 0, 0, 0, 0),
	(683, 63, 4, 4, 6, 0, 0, 0, 4),
	(684, 63, 12, 2, 6, 0, 0, 0, 2),
	(685, 63, 13, 0, 6, 0, 0, 0, 0),
	(686, 63, 15, 5, 6, 0, 1, 4, 0),
	(687, 63, 16, 0, 6, 0, 0, 0, 0),
	(690, 64, 4, 2, 6, 0, 0, 0, 2),
	(691, 64, 12, 2, 6, 0, 0, 0, 2),
	(692, 64, 13, 0, 6, 0, 0, 0, 0),
	(693, 64, 15, 6, 6, 0, 1, 5, 0),
	(694, 64, 16, 0, 6, 0, 0, 0, 0),
	(697, 65, 4, 5, 7, 0, 0, 2, 3),
	(698, 65, 12, 4, 7, 0, 0, 0, 4),
	(699, 65, 13, 0, 7, 0, 0, 0, 0),
	(700, 65, 15, 0, 7, 0, 0, 0, 0),
	(701, 65, 16, 0, 7, 0, 0, 0, 0),
	(704, 66, 4, 3, 7, 0, 0, 0, 3),
	(705, 66, 12, 6, 7, 0, 0, 0, 6),
	(706, 66, 13, 0, 7, 0, 0, 0, 0),
	(707, 66, 15, 2, 7, 0, 0, 2, 0),
	(708, 66, 16, 1, 7, 0, 0, 0, 1),
	(711, 67, 4, 1, 7, 0, 0, 0, 1),
	(712, 67, 12, 5, 7, 0, 1, 2, 2),
	(713, 67, 13, 0, 7, 0, 0, 0, 0),
	(714, 67, 15, 0, 7, 0, 0, 0, 0),
	(715, 67, 16, 0, 7, 0, 0, 0, 0),
	(718, 68, 4, 2, 7, 0, 0, 2, 6),
	(719, 68, 12, 2, 7, 0, 0, 0, 2),
	(720, 68, 13, 0, 7, 0, 0, 0, 0),
	(721, 68, 15, 0, 7, 0, 0, 0, 0),
	(722, 68, 16, 0, 7, 0, 0, 0, 0),
	(725, 69, 4, 6, 7, 0, 1, 3, 2),
	(726, 69, 12, 3, 7, 0, 0, 0, 3),
...
-- Dumping data for table cluster.tb_rules: ~0 rows (approximately)
...
-- Dumping structure for table cluster.tb_val_rules
...
-- Dumping data for table cluster.tb_val_rules: ~0 rows (approximately)
