...
-- Dumping data for table cluster_dosen.tb_dosen: ~20 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `tb_penelitian` (
  ...
  `bidang_ilmu` varchar(50) NOT NULL DEFAULT '0',
...
INSERT INTO `tb_penelitian` (`id`, `kode_dosen`, `judul_jurnal`, `bidang_ilmu`, `mata_kuliah`, `tahunJurnal`, `judulBimbingan`) VALUES
	...
	(58, '31', 'Jurnal Implementasi Design Clean Code', '16', 'ada ji', '2021', 'asdasds'),
	(64, '31', '-', '12', '', '2022', 'asd');
...
-- Dumping data for table cluster_dosen.tb_rel_dosen: ~141 rows (approximately)
INSERT INTO `tb_rel_dosen` (`ID`, `id_dosen`, `id_kriteria`, `nilai`, `prodi_id`, `nilai_kriteria`, `penelitian`, `pengajaran`, `bimbingan`) VALUES
	...
	(455, 30, 4, 0, 11, 0, 0, 0, 1),
	(456, 30, 12, 0, 11, 0, 0, 0, 0),
	(457, 30, 13, 0, 11, 0, 0, 0, 0),
	(458, 30, 15, 0, 11, 0, 3, 2, 2),
	(459, 30, 16, 0, 11, 0, 1, 2, 1),
	(460, 31, 4, 0, 11, 0, 0, 0, 0),
	(461, 31, 12, 0, 11, 0, 0, 0, 1),
	(462, 31, 13, 0, 11, 0, 0, 0, 0),
	(463, 31, 15, 0, 11, 0, 0, 0, 0),
	(464, 31, 16, 1, 11, 0, 1, 0, 0),
...
-- Dumping data for table cluster_dosen.tb_rules: ~37 rows (approximately)
...
-- Dumping structure for table cluster_dosen.tb_rule_bimbingan
CREATE TABLE IF NOT EXISTS `tb_rule_bimbingan` (
  `id` int NOT NULL,
  `judul_bimbingan` varchar(255) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Dumping data for table cluster_dosen.tb_rule_bimbingan: ~0 rows (approximately)

-- Dumping structure for table cluster_dosen.tb_rule_penelitian
CREATE TABLE IF NOT EXISTS `tb_rule_penelitian` (
  `id` int NOT NULL,
  `judul_penelitian` varchar(255) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Dumping data for table cluster_dosen.tb_rule_penelitian: ~0 rows (approximately)

-- Dumping structure for table cluster_dosen.tb_rule_pengajaran
CREATE TABLE IF NOT EXISTS `tb_rule_pengajaran` (
  `id` int NOT NULL,
  `mata_kuliah` varchar(50) NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Dumping data for table cluster_dosen.tb_rule_pengajaran: ~0 rows (approximately)
